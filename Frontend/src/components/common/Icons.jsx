  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-4.5-2.25a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z"
      />
    </svg>
  )
}

export function LogoutIcon({ className = 'h-5 w-5 shrink-0' }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
